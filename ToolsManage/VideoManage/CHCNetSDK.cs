...
namespace ToolsManage.VideoManage
{
    ...
    public class CHCNetSDK
    {
        ...
        const string dllName = @"\HikVideodll\NetNvr\HCNetSDK.dll";
        ...
        **********************************************************/
        ...
        public struct NET_DVR_FOCUSMODE_CFG
        {
            ...
            public uint wMinFocusDistance; /* 最小聚焦距离，单位CM,  0-自动，0xffff-无穷远 */
        ...
        public delegate void LOGINRESULTCALLBACK(Int32 lUserID, uint dwResult, ref NET_DVR_DEVICEINFO_V30 lpDeviceInfo, IntPtr pUser);
        ...
        {
            public byte byEnable;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = URL_LEN)]
            public byte[] strURL;
        ...
        //温度检测报警
        public const int COMM_THERMOMETRY_ALARM = 0x5210;  //温度报警上传
        ...
        //温度报警（检测温度和配置温度比较报警）
        [StructLayoutAttribute(LayoutKind.Sequential)]
        unsafe public struct NET_DVR_THERMOMETRY_ALARM
        {
            public uint dwSize;
            public uint dwChannel;//通道号
            public byte byRuleID;//规则ID
        ...
        //温差报警
        [StructLayoutAttribute(LayoutKind.Sequential)]
        unsafe public struct NET_DVR_THERMOMETRY_DIFF_ALARM
        {
            public uint dwSize;
            public uint dwChannel;//通道号
        ...
        public const int NET_DVR_GET_REALTIME_THERMOMETRY = 3629;  //温度报警上传
        //实时温度检测条件结构
        ...
        public struct NET_DVR_THERMOMETRY_UPLOAD
        {
            ...
            public void Init()
            {
                struPointThermCfg = new CHCNetSDK.NET_DVR_POINT_THERM_CFG();
                struLinePolygonThermCfg = new CHCNetSDK.NET_DVR_LINEPOLYGON_THERM_CFG();
            }
        }
