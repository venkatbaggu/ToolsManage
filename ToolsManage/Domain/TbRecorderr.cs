...
namespace ToolsManage.Domain
{
    ...
    [DataObject]
    [Description("")]
    [BindTable("tb_RecordErr", Description = "", ConnName = "ToolsManage", DbType = DatabaseType.SqlServer)]
    public partial class TbRecorderr : ITbRecorderr
    {
        #region 属性
        private Int64 _ID;
        /// <summary></summary>
        ...
        #region 字段名
        /// <summary>取得TbRecorderr字段信息的快捷方式</summary>
        ...
        /// <summary>取得TbRecorderr字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary></summary>
    ...
    /// <summary>TbRecorderr接口</summary>
    /// <remarks></remarks>
    public partial interface ITbRecorderr
    {
        #region 属性
        /// <summary></summary>
        Int64 ID { get; set; }
