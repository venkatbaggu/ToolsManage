...
namespace ToolsManage.BaseClass
{
    ...
    public class SerialPortMain
    {
        ...
        public SerialPortMain(string name, SerialPortBaudRates baud, Parity par, SerialPortDatabits dBits, StopBits sBits)
        {
            _portName = name;
            _baudRate = baud;
            _parity = par;
        ...
        /// <param name="dBits">数据位</param>
        /// <param name="name">串口号</param>
        public SerialPortMain(string name, string baud, string par, string dBits, string sBits)
        {
            _portName = name;
