...
namespace ToolsManage.BaseClass.SeralClass
{
    ...
    public class SerialPortVoice
    {
        ...
        #region 变量属性
        private string _portName = "COM3";//串口号，默认COM1
        ...
        public SerialPortVoice(string name, SerialPortBaudRates baud, Parity par, SerialPortDatabits dBits, StopBits sBits)
        {
            _portName = name;
            _baudRate = baud;
            _parity = par;
        ...
        /// <param name="dBits">数据位</param>
        /// <param name="name">串口号</param>
        public SerialPortVoice(string name, string baud, string par, string dBits, string sBits)
        {
            _portName = name;
