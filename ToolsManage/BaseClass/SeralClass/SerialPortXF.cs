...
namespace ToolsManage.BaseClass.SeralClass
{
    ...
    public class SerialPortXF
    {
        ...
        #region 变量属性
        private string _portName = "COM4";//串口号，默认COM4
        ...
        public SerialPortXF(string name, SerialPortBaudRates baud, Parity par, SerialPortDatabits dBits, StopBits sBits)
        {
            _portName = name;
            _baudRate = baud;
            _parity = par;
        ...
        /// <param name="dBits">数据位</param>
        /// <param name="name">串口号</param>
        public SerialPortXF(string name, string baud, string par, string dBits, string sBits)
        {
            _portName = name;
