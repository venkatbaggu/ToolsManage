...
namespace ToolsManage.BaseClass.SeralClass
{
    ...
    public class SerialPortAir
    {
        ...
        public SerialPortAir(string name, SerialPortBaudRates baud, Parity par, SerialPortDatabits dBits, StopBits sBits)
        {
            _portName = name;
            _baudRate = baud;
            _parity = par;
        ...
        /// <param name="dBits">数据位</param>
        /// <param name="name">串口号</param>
        public SerialPortAir(string name, string baud, string par, string dBits, string sBits)
        {
            _portName = name;
